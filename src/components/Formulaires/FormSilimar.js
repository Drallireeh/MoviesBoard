    ...
    return (
        <div className="row">
            <div className="form-group col-md-4">
                ...
                <input required type="text" className="form-control" name="title" id={`title${index}`} onChange={(event) => props.onUpdateSimilarMovies(event, index)} defaultValue={similar.title} placeholder="Nom de l'acteur" />
            </div>
            ...
            <div className="form-group col-md-4">
                ...
                <input required className="form-control" type="date" name="release_date" id={`release_similar${index}`} onChange={(event) => props.onUpdateSimilarMovies(event, index)} defaultValue={similar.release_date} placeholder="Nom du personnage" />
            </div>
